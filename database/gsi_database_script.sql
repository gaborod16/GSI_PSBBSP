...
CREATE SEQUENCE "gsi_database"."information_schema"."account__account_id_seq";

CREATE TABLE "gsi_database"."information_schema"."account" (
                "_account_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."account__account_id_seq"'),
...
COMMENT ON COLUMN "gsi_database"."information_schema"."account"."_account_password" IS 'SHA-256 creates 65 character strings';


ALTER SEQUENCE "gsi_database"."information_schema"."account__account_id_seq" OWNED BY "gsi_database"."information_schema"."account"."_account_id";

CREATE SEQUENCE "gsi_database"."information_schema"."comment__comment_id_seq";

CREATE TABLE "gsi_database"."information_schema"."comment" (
                "_comment_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."comment__comment_id_seq"'),
...
ALTER SEQUENCE "gsi_database"."information_schema"."comment__comment_id_seq" OWNED BY "gsi_database"."information_schema"."comment"."_comment_id";

CREATE SEQUENCE "gsi_database"."information_schema"."dataclass__dataclass_id_seq";

CREATE TABLE "gsi_database"."information_schema"."dataclass" (
                "_dataclass_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."dataclass__dataclass_id_seq"'),
...
ALTER SEQUENCE "gsi_database"."information_schema"."dataclass__dataclass_id_seq" OWNED BY "gsi_database"."information_schema"."dataclass"."_dataclass_id";

CREATE SEQUENCE "gsi_database"."information_schema"."organization_unit__organization_unit_id_seq";

CREATE TABLE "gsi_database"."information_schema"."organization_unit" (
                "_organization_unit_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."organization_unit__organization_unit_id_seq"'),
                "_organization_unit_name" VARCHAR(255),
                CONSTRAINT "_organization_unit_id" PRIMARY KEY ("_organization_unit_id")
);


ALTER SEQUENCE "gsi_database"."information_schema"."organization_unit__organization_unit_id_seq" OWNED BY "gsi_database"."information_schema"."organization_unit"."_organization_unit_id";

CREATE SEQUENCE "gsi_database"."information_schema"."process__process_id_seq";

CREATE TABLE "gsi_database"."information_schema"."process" (
                "_process_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."process__process_id_seq"'),
...
ALTER SEQUENCE "gsi_database"."information_schema"."process__process_id_seq" OWNED BY "gsi_database"."information_schema"."process"."_process_id";
...
CREATE TABLE "gsi_database"."information_schema"."process_dataclass" (
                ...
                "_problem" VARCHAR(1000),
                "_importance" VARCHAR(255),
                "_solution" VARCHAR(1000),
                "_subsystem_id" INTEGER NOT NULL,
                "_project_id" INTEGER NOT NULL,
...
CREATE SEQUENCE "gsi_database"."information_schema"."project__project_id_seq";

CREATE TABLE "gsi_database"."information_schema"."project" (
                "_project_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."project__project_id_seq"'),
...
ALTER SEQUENCE "gsi_database"."information_schema"."project__project_id_seq" OWNED BY "gsi_database"."information_schema"."project"."_project_id";
...
CREATE SEQUENCE "gsi_database"."information_schema"."subsystem__subsystem_id_seq";

CREATE TABLE "gsi_database"."information_schema"."subsystem" (
                "_subsystem_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."subsystem__subsystem_id_seq"'),
...
ALTER SEQUENCE "gsi_database"."information_schema"."subsystem__subsystem_id_seq" OWNED BY "gsi_database"."information_schema"."subsystem"."_subsystem_id";
...
CREATE SEQUENCE "gsi_database"."information_schema"."support_system__support_system_id_seq";

CREATE TABLE "gsi_database"."information_schema"."support_system" (
                "_support_system_id" INTEGER NOT NULL DEFAULT nextval('"gsi_database"."information_schema"."support_system__support_system_id_seq"'),
                "_support_system_name" VARCHAR(255),
                CONSTRAINT "_support_system_id" PRIMARY KEY ("_support_system_id")
);


ALTER SEQUENCE "gsi_database"."information_schema"."support_system__support_system_id_seq" OWNED BY "gsi_database"."information_schema"."support_system"."_support_system_id";

ALTER TABLE "gsi_database"."information_schema"."project" ADD CONSTRAINT "account_project_fk1"
FOREIGN KEY ("_account_id_secretary")
REFERENCES "gsi_database"."information_schema"."account" ("_account_id")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES "gsi_database"."information_schema"."dataclass" ("_dataclass_id")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES "gsi_database"."information_schema"."organization_unit" ("_organization_unit_id")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES "gsi_database"."information_schema"."process" ("_process_id")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES "gsi_database"."information_schema"."project" ("_project_id")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES "gsi_database"."information_schema"."subsystem" ("_subsystem_id")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES "gsi_database"."information_schema"."support_system" ("_support_system_id")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

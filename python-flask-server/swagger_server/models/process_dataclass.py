...
class ProcessDataclass(Model):
    ...
    __tablename__   = 'process_dataclass'
    _process_id = Column(Integer, ForeignKey('process._process_id'), primary_key=True)
    _dataclass_id = Column(Integer, ForeignKey('dataclass._dataclass_id'), primary_key=True)
